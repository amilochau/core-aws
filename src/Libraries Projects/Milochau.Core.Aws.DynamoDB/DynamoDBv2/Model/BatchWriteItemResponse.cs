...
// https://github.com/aws/aws-sdk-net/blob/master/sdk/src/Services/DynamoDBv2/Generated/Model/BatchWriteItemResponse.cs
namespace Milochau.Core.Aws.DynamoDB.DynamoDBv2.Model
{
    ...
    public partial class BatchWriteItemResponse : AmazonWebServiceResponse
    {
        ...
        ///  </li> </ul>
        /// </summary>
        public List<ConsumedCapacity> ConsumedCapacity { get; set; } = new List<ConsumedCapacity>();
        ...
        ///  </li> </ul>
        /// </summary>
        public Dictionary<string, List<ItemCollectionMetrics>> ItemCollectionMetrics { get; set; } = new Dictionary<string, List<ItemCollectionMetrics>>();
        ...
        /// </para>
        /// </summary>
        public Dictionary<string, List<WriteRequest>> UnprocessedItems { get; set; } = new Dictionary<string, List<WriteRequest>>();
    }
}