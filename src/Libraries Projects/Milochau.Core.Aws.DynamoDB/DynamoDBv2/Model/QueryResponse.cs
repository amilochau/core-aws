...
// https://github.com/aws/aws-sdk-net/blob/master/sdk/src/Services/DynamoDBv2/Generated/Model/QueryResponse.cs
namespace Milochau.Core.Aws.DynamoDB.DynamoDBv2.Model
{
    ...
    public partial class QueryResponse : AmazonWebServiceResponse
    {
        ...
        /// </para>
        /// </summary>
        public List<Dictionary<string, AttributeValue>> Items { get; set; } = new List<Dictionary<string, AttributeValue>>();
        ...
        /// </para>
        /// </summary>
        public Dictionary<string, AttributeValue> LastEvaluatedKey { get; set; } = new Dictionary<string, AttributeValue>();
