...
// https://github.com/aws/aws-sdk-net/blob/master/sdk/src/Services/DynamoDBv2/Generated/Model/ExpectedAttributeValue.cs
namespace Milochau.Core.Aws.DynamoDB.DynamoDBv2.Model
{
    ...
    public partial class ExpectedAttributeValue
    {
        ...
        /// </para>
        /// </summary>
        public List<AttributeValue> AttributeValueList { get; set; } = new List<AttributeValue>();
