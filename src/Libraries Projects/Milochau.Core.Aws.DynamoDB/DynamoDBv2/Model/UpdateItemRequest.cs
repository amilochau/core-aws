...
// https://github.com/aws/aws-sdk-net/blob/master/sdk/src/Services/DynamoDBv2/Generated/Model/UpdateItemRequest.cs
namespace Milochau.Core.Aws.DynamoDB.DynamoDBv2.Model
{
    ...
    public partial class UpdateItemRequest : AmazonDynamoDBRequest
    {
        ...
        /// </para>
        /// </summary>
        public Dictionary<string, AttributeValueUpdate> AttributeUpdates { get; set; } = new Dictionary<string, AttributeValueUpdate>();
