...
namespace Milochau.Core.Aws.DynamoDB.DynamoDBv2.Model
{
    ...
    public partial class QueryRequest : AmazonDynamoDBRequest
    {
        ...
        /// </para>
        /// </summary>
        public Dictionary<string, AttributeValue> ExclusiveStartKey { get; set; } = new Dictionary<string, AttributeValue>();

        // Check to see if ExclusiveStartKey property is set
        internal bool IsSetExclusiveStartKey()
        {
            return ExclusiveStartKey != null && ExclusiveStartKey.Count > 0;
        }
        ...
        {
            return KeyConditionExpression != null;
        }
        ...
        /// </para>
        /// </summary>
        public Dictionary<string, Condition> KeyConditions { get; set; } = new Dictionary<string, Condition>();

        // Check to see if KeyConditions property is set
        internal bool IsSetKeyConditions()
        {
            return KeyConditions != null && KeyConditions.Count > 0;
        }
        ...
        /// </para>
        /// </summary>
        public Dictionary<string, Condition> QueryFilter { get; set; } = new Dictionary<string, Condition>();

        // Check to see if QueryFilter property is set
        internal bool IsSetQueryFilter()
        {
            return QueryFilter != null && QueryFilter.Count > 0;
        }
