...
// https://github.com/aws/aws-sdk-net/blob/master/sdk/src/Services/DynamoDBv2/Generated/Model/ConsumedCapacity.cs
namespace Milochau.Core.Aws.DynamoDB.DynamoDBv2.Model
{
    ...
    public partial class ConsumedCapacity
    {
        ...
        /// </para>
        /// </summary>
        public Dictionary<string, Capacity> GlobalSecondaryIndexes { get; set; } = new Dictionary<string, Capacity>();
        ...
        /// </para>
        /// </summary>
        public Dictionary<string, Capacity> LocalSecondaryIndexes { get; set; } = new Dictionary<string, Capacity>();
