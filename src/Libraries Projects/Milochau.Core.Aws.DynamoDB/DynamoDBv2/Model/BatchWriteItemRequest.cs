...
// https://github.com/aws/aws-sdk-net/blob/master/sdk/src/Services/DynamoDBv2/Generated/Model/BatchWriteItemRequest.cs
namespace Milochau.Core.Aws.DynamoDB.DynamoDBv2.Model
{
    ...
    public partial class BatchWriteItemRequest : AmazonDynamoDBRequest
    {
        ...
        ///  </li> </ul> </li> </ul>
        /// </summary>
        public Dictionary<string, List<WriteRequest>> RequestItems { get; set; } = new Dictionary<string, List<WriteRequest>>();
