...
// https://github.com/aws/aws-sdk-net/blob/master/sdk/src/Services/DynamoDBv2/Generated/_netstandard/AmazonDynamoDBClient.cs
namespace Milochau.Core.Aws.DynamoDB.DynamoDBv2
{
    ...
    public partial class AmazonDynamoDBClient : Core.Runtime.AmazonServiceClient, IAmazonDynamoDB
    {
        ...
        public virtual Task<BatchWriteItemResponse> BatchWriteItemAsync(Dictionary<string, List<WriteRequest>> requestItems, CancellationToken cancellationToken)
        {
