...
namespace Milochau.Core.Aws.Core.XRayRecorder.Core.Internal.Utils
{
    ...
    public static class IPEndPointExtension
    {
        ...
        public static bool TryParse(string input, [NotNullWhen(true)] out IPEndPoint? endPoint)
        {
            endPoint = null;
        ...
        /// <returns>true if <paramref name="input"/> converted successfully; otherwise, false.</returns>
        public static bool TryParse(string input, [NotNullWhen(true)] out HostEndPoint? hostEndpoint)
        {
        ...
        /// <returns>true if <paramref name="input"/> converted successfully; otherwise, false.</returns>
        public static bool TryParse(string input, [NotNullWhen(true)] out EndPoint? endpoint)
        {
            endpoint = null;
        ...
        /// <returns></returns>
        public static bool TryParse(string? daemonAddress, [NotNullWhen(true)] out DaemonConfig? daemonEndPoint)
        {
            daemonEndPoint = null;
        ...
        private static bool TryParseDaemonAddress(string[] daemonAddress, [NotNullWhen(true)] out DaemonConfig? endPoint)
        {
            endPoint = null;
