...
namespace Milochau.Core.Aws.DynamoDB.Generator.Models
{
    internal readonly record struct DynamoDbClassToGenerate
    {
        ...
        public DynamoDbClassToGenerate(string @namespace, string @class, string? tableNameSuffix, string? indexName, ClassType type, List<DynamoDbAttributeToGenerate> dynamoDbAttributes, List<DiagnosticInfo> diagnostics)
        {
            Namespace = @namespace;
            Class = @class;
