...
namespace Milochau.Core.Aws.DynamoDB.Helpers
{
    ...
    public static partial class AttributesExtensions
    {
        ...
        public static IEnumerable<KeyValuePair<string, AttributeValue>> AppendValue<TEntity>(this IEnumerable<KeyValuePair<string, AttributeValue>> attributes, string key, IDynamoDbEntity<TEntity>? value)
            where TEntity: IDynamoDbEntity<TEntity>
        {
            return attributes.AppendValue(key, value?.FormatForDynamoDb());
        }
        ...
        public static IEnumerable<KeyValuePair<string, AttributeValue>> AppendValue<TEntity>(this IEnumerable<KeyValuePair<string, AttributeValue>> attributes, string key, IEnumerable<TEntity>? value)
            where TEntity : IDynamoDbEntity<TEntity>
        {
            ...
            return attributes.Append(new($":v_{key}", new AttributeValue { L = value.Select(x => new AttributeValue { M = x.FormatForDynamoDb() }).ToList() }));
        }
